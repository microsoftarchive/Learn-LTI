...
export const b2cPolicies = {
  names: {
    signUpSignIn: 'B2C_1_signup_signin_LTI' // RB make not hardcoded
  },
  authorities: {
    signUpSignIn: {
      // RB not sure if i have to modify this
      authority: 'https://ltimoodleb2c.b2clogin.com/ltimoodleb2c.onmicrosoft.com/B2C_1_signup_signin_LTI'
