...
import { StudentViewSection, StudentViewSectionStyles, StudentViewSectionProps } from '../StudentView/StudentViewSection';
import { useStore } from '../../Stores/Core';
import { AssignmentLinksList } from '../AssignmentLinks/AssignmentLinksList';
import { useObserver } from 'mobx-react-lite';
import _ from 'lodash';
import { StudentViewLearnItemsList } from '../StudentView/StudentViewLearnItemsList';
...
const PreviewContentInner = ({ styles }: IStylesOnly<StudentViewContentStyles>): JSX.Element => {
...
export const PreviewContent = styled(PreviewContentInner, studentViewContentStyles);