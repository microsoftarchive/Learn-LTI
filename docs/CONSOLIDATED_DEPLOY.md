...
Go to the [B2C setup](https://github.com/UCL-MSc-Learn-LTI/Learn-LTI/blob/consolidated_deploy_branch/deployment/B2C_Docs/B2C_Deployment.md) for B2C deployment.
